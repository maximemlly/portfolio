    ...
    <section className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 gap-6">
        {projects.map((project) => (
          <div
            key={project.id}
            className="group border border-white/7 hover:border-accent/30 bg-white/[0.02] hover:bg-accent/[0.03] rounded-2xl overflow-hidden transition-all duration-200"
          >
            {project.thumbnail && (
